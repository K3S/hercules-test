...
system -v "SAVOBJ OBJ(*ALL) LIB(HERC) DEV(*SAVF) SAVF(QGPL/HERCSAVFL) TGTRLS(V7R2M0)";
system -v "SAV DEV('/qsys.lib/qgpl.lib/hercsavfi.file') OBJ(('${BASEDIR}/*' *INCLUDE)) TGTRLS(V7R2M0)";
